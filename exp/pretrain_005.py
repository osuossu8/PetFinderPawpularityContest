...
def calc_cv(model_paths):
    ...
    df = pd.read_csv("input/petfinder1_train_test_image_with_pseudo_label_rm_new_train_data.csv")
...
# data
train = pd.read_csv("input/petfinder1_train_test_image_with_pseudo_label_rm_new_train_data.csv")
