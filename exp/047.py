...
class CFG:
    ...
    MODEL_NAME = "tf_efficientnet_b7_ns" # "tf_efficientnet_b4_ns" # "swin_large_patch4_window7_224" # "swin_large_patch4_window12_384" # "swin_base_patch4_window7_224"
    in_chans = 3
    ID_COL = 'Id'
...
class Pet2Model(nn.Module):
    def __init__(self, model_name):
        ...
        self.dense = nn.Linear(2560, CFG.TARGET_DIM)
