...
class CFG:
    ...
    in_chans = 3
    ID_COL = 'image_name' # 'Id'
    TARGET_COL = 'pseudo_label' # 'Pawpularity'
    TARGET_DIM = 1
    EVALUATION = 'RMSE'
...
def calc_cv(model_paths):
    ...
    df = pd.read_csv("input/petfinder1_train_test_image_with_pseudo_label_rm_new_train_data_more_clean.csv")
...
def create_folds(data, num_splits):
    ...
    #    data[CFG.TARGET_COL], bins=num_bins, labels=False
    #)
...
# data
train = pd.read_csv("input/petfinder1_train_test_image_with_pseudo_label_rm_new_train_data_more_clean.csv")
