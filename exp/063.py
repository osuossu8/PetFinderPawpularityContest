...
class CFG:
    ...
    MODEL_NAME = "inception_v4" # "swin_base_patch4_window7_224" # "swin_large_patch4_window12_384" # "swin_base_patch4_window7_224"
    in_chans = 3
    ID_COL = 'Id'
    TARGET_COL = 'Pawpularity'
    TARGET_DIM = 1
    EVALUATION = 'RMSE'
    IMG_SIZE = 299 # 384 # 224 # 512 # 256 # 900
    EARLY_STOPPING = True
    APEX = False # True
    DEBUG = False # True
    FEATURE_COLS = [
...
class Pet2Model(nn.Module):
    def __init__(self, model_name):
        ...
        self.model.last_linear = nn.Linear(self.model.num_features, 128)
