...
class CFG:
    ...
    MODEL_NAME = "tf_efficientnet_b4_ns" # "swin_large_patch4_window12_384" # "swin_base_patch4_window7_224"
    in_chans = 3
    ID_COL = 'Id'
    TARGET_COL = 'Pawpularity'
    TARGET_DIM = 1
    EVALUATION = 'RMSE'
    IMG_SIZE = 512 # 384 # 224 # 512 # 256 # 900
    EARLY_STOPPING = True
    APEX = False # True
    DEBUG = False # True
    FEATURE_COLS = [
...
class Pet2Model(nn.Module):
    def __init__(self, model_name):
        ...
        self.dense = nn.Linear(1792, CFG.TARGET_DIM)
