...
class CosineAnnealingWarmupRestartsV2(_LRScheduler):
    """
...
for fold in range(5):
    ...
    scheduler = CosineAnnealingWarmupRestartsV2(optimizer, first_cycle_steps=int((494 * CFG.epochs) / 5), cycle_mult=1.0, max_lr=CFG.LR, min_lr=CFG.ETA_MIN, warmup_steps=int((494 * CFG.epochs) / 50))
